...
import { ModelDesignOptions } from "@/components/ModelDesignOptions";
      ...
      <div className="flex items-center h-full">
        ...
        <Card className="p-8 bg-gradient-to-br from-white to-gray-50/50 border border-gray-200 hover:shadow-xl transition-all duration-300 h-[600px] overflow-hidden">
          ...
          <div className="overflow-y-auto h-[440px] pr-2 space-y-4 mb-8">
            {currentFeatures.slice(0, 6).map((feature: any, index: number) => <div key={`${selectedProduct}-${index}`} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
...
Traditional wellness programs failed to deliver results. Erakulis' digital wellness solution delivers lasting impact on people's health and key business KPIs, backed by data & technology, and a holistic approach.</p>
      ...
      <section id="cr7-section" className="py-20 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                <img src="/lovable-uploads/dd45002c-7c8c-4596-b78d-96522760d5f7.png" alt="Cristiano Ronaldo" className="w-full h-[500px] object-cover" />
      ...
      <section id="ecosystem" className="py-20 bg-gradient-to-br from-background via-gray-50/50 to-background relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-foreground">
              Experience the <span className="text-primary">Complete Ecosystem</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4">Industry-Specific Solutions</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Tailored Wellness Solutions for Every Industry</h2>
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
              ERAKULIS adapts to your unique challenges across diverse sectors, delivering measurable results that transform workforce well-being into tangible business outcomes.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* HR Leaders */}
            <Card className="p-8 space-y-6 bg-gradient-to-br from-white to-blue-50/30 border border-blue-200/50 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-blue-100 text-blue-700">Tech Consultancies</Badge>
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-bold text-primary">25%</div>
                    <div className="text-sm text-muted-foreground">Absenteeism Reduction</div>
                  </div>
                </div>
              </div>
              
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-blue-700">HR Leaders</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Personalized Plans</div>
                  <div className="text-xs text-muted-foreground">Fitness & mental health</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">400+ Integrations</div>
                  <div className="text-xs text-muted-foreground">Wearables & health apps</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Productivity Boost</div>
                  <div className="text-xs text-muted-foreground">Enhanced retention rates</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Real-time Analytics</div>
                  <div className="text-xs text-muted-foreground">Health-Monitor Dashboard</div>
                </div>
              </div>
            ...
            {/* Operations Managers */}
            <Card className="p-8 space-y-6 bg-gradient-to-br from-white to-green-50/30 border border-green-200/50 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-green-100 text-green-700">Manufacturing</Badge>
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-bold text-primary">3-6x</div>
                    <div className="text-sm text-muted-foreground">ROI</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-green-700">Operations Managers</h3>
                <p className="text-muted-foreground">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Combat Sedentarism</div>
                  <div className="text-xs text-muted-foreground">Active lifestyle programs</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Actionable Insights</div>
                  <div className="text-xs text-muted-foreground">Wearable data analysis</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Energy & Focus</div>
                  <div className="text-xs text-muted-foreground">Increased productivity</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Safety Improvement</div>
                  <div className="text-xs text-muted-foreground">Reduced workplace injuries</div>
                </div>
              </div>
            ...
            {/* Startup Founders */}
            <Card className="p-8 space-y-6 bg-gradient-to-br from-white to-purple-50/30 border border-purple-200/50 hover:shadow-xl transition-all duration-300">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-purple-100 text-purple-700">Startups</Badge>
                  <div className="flex items-center gap-4">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-purple-700">Startup Founders</h3>
                <p className="text-muted-foreground">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Scalable Solution</div>
                  <div className="text-xs text-muted-foreground">Grows with your team</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Stress Management</div>
                  <div className="text-xs text-muted-foreground">Mental wellness support</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Talent Attraction</div>
                  <div className="text-xs text-muted-foreground">Competitive advantage</div>
                </div>
                <div className="space-y-1">
                  <div className="font-semibold text-sm">Team Morale</div>
                  <div className="text-xs text-muted-foreground">Enhanced engagement</div>
                </div>
              </div>

              <Button variant="outline" className="w-full">
                Build Your Wellness Culture
              </Button>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Calculate Your Wellness ROI</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See the tangible impact Erakulis can have on your organization's bottom line with our interactive ROI calculator.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-background to-secondary/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Our Model</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
