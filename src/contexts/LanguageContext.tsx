    ...
    try {
      ...
      const commonTranslations: Record<Language, Record<string, string>> = {
        ...
        'es': {
          ...
          'Base Fee': 'Taxa Base',
          'Covers platform access, onboarding, technical support, and reporting tools. Ensures foundational delivery and full operational readiness from day one.': 'Cobre acesso à plataforma, integração, suporte técnico e ferramentas de relatórios. Garante entrega fundamental e prontidão operacional completa desde o primeiro dia.',
          'Get Started Base Fee': 'Começar',
          'Success Fee': 'Taxa de Sucesso',
          'Only applied when pre-defined KPIs are met. You pay only when we deliver measurable health and productivity impact.': 'Aplicada apenas quando os KPIs pré-definidos são atingidos. Só paga quando entregamos impacto mensurável na saúde e produtividade.',
          'Pay on Results': 'Pague por Resultados',
          'Scale on Success': 'Escalar com Sucesso',
          'Once impact is proven we progressively expand the program, reaching a broader user base with confidence and cost-efficiency, backed by results.': 'Uma vez que o impacto é comprovado, expandimos progressivamente o programa, alcançando uma base de utilizadores mais ampla com confiança e eficiência de custos, suportado por resultados.',
          'Learn More Scale': 'Saber Mais',
          'Ready to Transform Your Business?': 'Pronto para Transformar o Seu Negócio?',
          ...
          'Experienced wellness experts design and adapt corporate programs based on your team\'s specific needs and health goals.': 'Especialistas experientes em bem-estar desenham e adaptam programas corporativos baseados nas necessidades específicas e objetivos de saúde da sua equipe.',
          'Live Expert Consultations': 'Consultas ao Vivo com Especialistas',
          'Scheduled one-on-one sessions with certified professionals for nutrition counseling, fitness coaching, and mental wellness support.': 'Sessões individuais agendadas com profissionais certificados para aconselhamento nutricional, coaching de fitness e suporte de bem-estar mental.',
          'Dedicated Wellness Specialists': 'Especialistas em Bem-estar Dedicados',
          'Assigned human wellness coordinators who understand your company culture and employee needs for optimal program success.': 'Coordenadores de bem-estar humanos designados que compreendem a cultura da sua empresa e necessidades dos funcionários para sucesso ótimo do programa.',
          'Professional Health Oversight': 'Supervisão Profissional de Saúde',
          'Medical professionals and certified wellness experts ensure all programs meet safety standards and health regulations.': 'Profissionais médicos e especialistas certificados em bem-estar garantem que todos os programas atendam padrões de segurança e regulamentações de saúde.',
          'Clients Managed': 'Clientes Gerenciados',
          'Success Rate B2B': 'Taxa de Sucesso',
