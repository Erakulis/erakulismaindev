          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                <T>Plan, track and transform your clients' journey with Erakulis. The intelligent platform that syncs professionals and clients.</T>
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 pt-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground font-medium"><T>100% Free</T></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-primary-light rounded-full animate-pulse"></div>
                <span className="text-sm text-muted-foreground font-medium"><T>+4,000 Videos</T></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-primary-glow rounded-full animate-pulse"></div>
                <span className="text-sm text-muted-foreground font-medium"><T>Unlimited Clients</T></span>
              </div>
            </div>
          </div>
          ...
          <div className="relative lg:block">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 bg-gradient-card p-4 rounded-xl shadow-medium animate-fade-in-up border border-primary/10">
                <div className="text-sm font-semibold text-primary"><T>Active users worldwide</T></div>
              </div>
              ...
              <div className="absolute -bottom-4 -right-4 p-4 rounded-xl shadow-glow animate-fade-in-up delay-300" style={{ backgroundColor: "#FFA953" }}>
                <div className="text-sm font-semibold text-primary-foreground"><T>High Retention Rate</T></div>
              </div>
            </div>
          </div>
        </div>
