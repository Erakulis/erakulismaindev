  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h2 className="text-3xl lg:text-5xl font-bold mb-6">Our Model</h2>
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-16">
        {pricingSteps.map((step, index) => (
          <Card key={index} className={`p-8 relative ${step.highlight ? 'ring-2 ring-primary shadow-xl' : ''} hover:shadow-lg transition-all duration-300`}>
            {step.highlight && (
